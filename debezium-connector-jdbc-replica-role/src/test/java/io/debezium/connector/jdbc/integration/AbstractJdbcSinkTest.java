...
import io.debezium.connector.jdbc.JdbcSinkConnectorReplicaRole;
...
public abstract class AbstractJdbcSinkTest {
    ...
    private JdbcSinkConnectorReplicaRole sinkConnector;
    ...
    protected void startSinkConnector(Map<String, String> properties) {
        sinkConnector = new JdbcSinkConnectorReplicaRole();
